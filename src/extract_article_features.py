...
NONARTICLE_WORDS = ['270', '480', 'tsgp', 'experienceID', 'api', 'setsize',\
    'containing','ID:','Getty','Images','video-cdn.buzzfeed.com', 'Video', \
    'Press','available','AFP','UPDATE', 'BuzzFeed', '})', 'Photo','Slate.', \
    'Image','Advertisement','taps','cover','size',' am','pm','homepage','js','webkit',\
    'iframe', 'This article is from the archive of our partner The Wire', \
    'This article is from the archive of our partner', 'READ ARTICLE', '@theatlantic.com',\
