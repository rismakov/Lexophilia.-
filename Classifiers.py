...
class Classifiers(object):
    ...
    def plot_roc_curve(self):
        ...
        for name, clf in zip(self.classifier_names, self.classifiers):
            ...
            print '\naccuracy score: {:.3%}'.format(accuracy_score(self._y_test, predictions))
            print "recall: {:.3%}".format(recall_score(self._y_test, predictions))
            print "precision: {:.3%}".format(precision_score(self._y_test, predictions))
